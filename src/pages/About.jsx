...
const About = () => {
  return (
    <section id="about" className="bg-neutral-900 min-h-screen py-20 md:py-32 border-t border-white/5 overflow-hidden">
      <div className="container-custom">
        
        {/* Header */}
        <div className="mb-16 md:mb-24 relative">
             <span className="block text-[18vw] md:text-[12rem] text-white/5 font-display font-bold absolute -top-16 md:-top-20 -left-6 md:-left-10 select-none pointer-events-none whitespace-nowrap">
               Profile
             </span>
             <motion.div 
        ...
        <div className="grid md:grid-cols-12 gap-20">
            ...
            <div className="md:col-span-7 space-y-16">
              <motion.h2 
                ...
                viewport={{ once: true }}
                className="text-2xl md:text-4xl font-display leading-tight text-white font-light"
              >
                  "{content.philosophy.longQuote}"
              </motion.h2>
              <div className="text-neutral-300 space-y-6 leading-relaxed font-sans text-lg font-light text-justify">
              ...
              <div className="pt-12 border-t border-white/10 grid grid-cols-2 lg:grid-cols-3 gap-12">
                  {content.stats.map((stat, i) => (
                    <div key={i}>
                        <span className="block text-5xl font-display text-crimson-500 mb-2">{stat.value}</span>
